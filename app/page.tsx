        ...
        <div className="w-full max-w-sm space-y-6 pt-10 text-center">
          ...
          <div className="bg-[#2d2448] p-6 rounded-2xl border border-pink-500/30 text-left">
            ...
            <p className="text-sm text-gray-200 leading-relaxed mt-4">
              {displayName}、まだモヤモヤしてるんじゃないかしら？正直言って、この診断だけじゃ本当の答えは出ないの。相手の気持ちも、これからどう動くかも、実際の状況を見なきゃ分からないことだらけだからよ。でも、一人で考えてても同じところをグルグル回るだけだし、友達に話してもスッキリはするけど解決はしないわ。だったら、恋愛相談のプロに本音で見てもらいなさい。客観的に、遠慮なく本当のところを教えてくれるから。おすすめは断然、電話での相談よ。
              チャット占いもあるけど、声で話す方が本音がポロッと出やすいし、その場で深く聞き返せるから、文字のやりとりよりずっと早く核心にたどり着けるの。私のおすすめは雷鳥先生。
              恋愛相談の実績が豊富で、相手の今の本心を濁さずズバ言い当ててくれるからリピーターが後を絶たないのよ。今も相談待ちができる人気ぶりだから、枠が空いてたらラッキーね。レビューも高評価よ。初回は3,000円分無料だから、まずはそのモヤモヤを吐き出すだけでも使ってみなさい。
            </p>
            <a
              href="#"
              target="_blank"
